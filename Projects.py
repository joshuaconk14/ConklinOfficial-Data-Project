...
def app():
    ...
    # intro
    st.write("Here is my ConklinOfficial Data Engineering and Analytics project demonstrating the relationship between KPIs and the type of reel posted, indicating what type of post performs best and which posts posts we should focus on.")
    st.write("")
    st.write("")
    ...
    # results
    st.write("### Analysis") #text should look like this, is it updated?
    st.write("")
    st.write("")
